...
function displayPics(){
  ...
  // console.log(rando);
  // DONE: In a sentence or two, explain why the previous line of code threw an error when we changed the constiable declaration from `const to `let`.
  // Because rando is declared with let it has a limited scope.  The console log is being called on rando outside of it's limited scope.
  console.log(viewed);
